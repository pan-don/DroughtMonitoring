...
def init_earth_engine():
    ...
    if key_json:
        ...
        local_key_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'secret-key.json')
        if os.path.exists(local_key_path):
            ...
            raise ValueError("GEE_KEY environment variable not found and secret-key.json not found in root directory.")
